...
class Player(Entity):
	def __init__(self, character, pos,groups,obstacle_sprites,create_attack,destroy_attack,create_magic):
	...
	def import_player_assets(self):
		character_path = 'graphics/player/'+self.character_info['asset_path']+'/'
